...
This information is cited from an article from \cite{Enisa2012}. 2'nd citation is from \cite{Goodwin2013}.
...
%\begin{figure}
%  \includesvg[width=180pt]{out/uml/SampleUML/SampleERD.svg}
%  \caption{Sample ERD .svg}
%  \label{fig:Sample ERD as .svg}
%\end{figure}